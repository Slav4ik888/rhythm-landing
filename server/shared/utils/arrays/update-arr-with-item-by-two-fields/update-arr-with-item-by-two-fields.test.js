...
describe(`ARRAY.JS - updateArrWithItemByTwoFields`, () => {
    it(`Обновляем по полю id`, () => {
        expect((0, _1.updateArrWithItemByTwoFields)([...m.mockArray], `field1`, `field2`, m.mockFieldUpdate)).toEqual(m.mockArrayUpdated);
    });
    it(`Обновляем несуществующим объектом, он добавляется к массиву`, () => {
        expect((0, _1.updateArrWithItemByTwoFields)([...m.mockArray], `field1`, `field2`, m.mockFieldAdd)).toEqual(m.mockArrayAdded);
    });
});
